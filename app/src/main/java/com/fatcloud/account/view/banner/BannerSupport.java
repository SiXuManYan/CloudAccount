package com.fatcloud.account.view.banner;
...
/**
 * 修正 indicator_drawable_selected 宽度固定
 * 使用时 shape 文件中设置宽高
 */
public class BannerSupport extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public BannerSupport(Context context) {
        this(context, null);
    }

    public BannerSupport(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BannerSupport(Context context, AttributeSet attrs, int defStyle) {
    ...
    public BannerSupport isAutoPlay(boolean isAutoPlay) {
        this.isAutoPlay = isAutoPlay;
        return this;
    }

    public BannerSupport setImageLoader(ImageLoaderInterface imageLoader) {
        this.imageLoader = imageLoader;
        return this;
    }

    public BannerSupport setDelayTime(int delayTime) {
        this.delayTime = delayTime;
        return this;
    }

    public BannerSupport setIndicatorGravity(int type) {
        switch (type) {
    ...
    public BannerSupport setBannerAnimation(Class<? extends ViewPager.PageTransformer> transformer) {
        try {
     ...
     * @return Banner
     */
    public BannerSupport setOffscreenPageLimit(int limit) {
        if (viewPager != null) {
     ...
     * @return Banner
     */
    public BannerSupport setPageTransformer(boolean reverseDrawingOrder, ViewPager.PageTransformer transformer) {
        viewPager.setPageTransformer(reverseDrawingOrder, transformer);
        return this;
    }

    public BannerSupport setBannerTitles(List<String> titles) {
        this.titles = titles;
        return this;
    }

    public BannerSupport setBannerStyle(int bannerStyle) {
        this.bannerStyle = bannerStyle;
        return this;
    }

    public BannerSupport setViewPagerIsScroll(boolean isScroll) {
        this.isScroll = isScroll;
        return this;
    }

    public BannerSupport setImages(List<?> imageUrls) {
...
//        Log.i(tag,"currentItem: "+currentItem);
    ...
    @Deprecated
    public BannerSupport setOnBannerClickListener(OnBannerClickListener listener) {
     ...
     * @return
     */
    public BannerSupport setOnBannerListener(OnBannerListener listener) {
