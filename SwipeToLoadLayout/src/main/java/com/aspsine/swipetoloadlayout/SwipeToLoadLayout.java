...
public class SwipeToLoadLayout extends ViewGroup {
    ...
    protected void onFinishInflate() {
        ...
        if (childNum == 3) {
            mTargetView = getChildAt(childNum - 1);
        } else if (childNum > 3) {
     ...
     * @param view
     */
    public void setRefreshHeaderView(@NonNull View view) {
    ...
    public void addView(View child) {
        if (mTargetView == null && getChildCount() == 2) {
            mTargetView = child;
     ...
     * @param view
     */
    public void setLoadMoreFooterView(@NonNull View view) {
    ...
    private void layoutChildren() {
        ...
        if (targetView != null) {
            lp = (MarginLayoutParams) targetView.getLayoutParams();
    ...
    RefreshCallback mRefreshCallback = new RefreshCallback() {
        ...
        public void onPrepare() {
            if (mHeaderView instanceof SwipeTrigger && STATUS.isStatusDefault(mStatus)) {
        ...
        public void onMove(int y, boolean isComplete, boolean automatic) {
            if (mHeaderView instanceof SwipeTrigger && STATUS.isRefreshStatus(mStatus)) {
        ...
        public void onRelease() {
            if (mHeaderView instanceof SwipeTrigger && STATUS.isReleaseToRefresh(mStatus)) {
        ...
        public void onComplete() {
            if (mHeaderView instanceof SwipeTrigger) {
    ...
    LoadMoreCallback mLoadMoreCallback = new LoadMoreCallback() {
        ...
        @Override
        public void onPrepare() {
            if (mFooterView instanceof SwipeTrigger && STATUS.isStatusDefault(mStatus)) {
        ...
        @Override
        public void onMove(int y, boolean isComplete, boolean automatic) {
            if (mFooterView instanceof SwipeTrigger && STATUS.isLoadMoreStatus(mStatus)) {
        ...
        @Override
        public void onRelease() {
            if (mFooterView instanceof SwipeTrigger && STATUS.isReleaseToLoadMore(mStatus)) {
        ...
        @Override
        public void onComplete() {
            if (mFooterView instanceof SwipeTrigger) {
